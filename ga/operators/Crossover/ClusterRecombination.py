...
class ClusterRecombination(BaseCrossover):
    ...
    def crossover(self, chromo11: np.ndarray, chromo22: np.ndarray, cluster_num):
        chromo1, chromo2 = deepcopy(chromo11), deepcopy(chromo22)
        ...
        if np.random.rand() < self.poc:
            ...
            # print("mapper1",mapper)
            # if len(mapper)!=length:
